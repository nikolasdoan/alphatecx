...
## Decisions
- [2026-09-16 — The public surface leads with structure, not quotes](decisions/2026-09-16-public-market-map.md) — `/market-map` ships three interactive graphs (supply chain by chain depth, 120-day correlation embedding, 24-hour market clock) because the research said 三竹股市 and every Taiwan flow site already cover quotes and 三大法人, while **nobody draws the relationship graph**. Crossing the two edge sets is the finding: 36 declared supply links, 15 pairs at ρ ≥ 0.70, **overlap zero** — every tight pair is same-sub-industry, not up/downstream
- [2026-09-15 — alphatecx is not sold; it feeds bizmap/marketecx](decisions/2026-09-15-alphatecx-feeds-bizmap-not-sold.md) — supersedes the 2026-08-08 commercialization plan: no Stripe gate, no headless app, no mobile. The private framing that deferred the investment-advice licensing gate becomes permanent instead. Key constraint: a licence travels with the **data**, not the repo — the TWSE 統編 bridge is OGDL and may reach a paid bizmap surface; FinMind/yfinance series may not
